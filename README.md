...
You can also open here an [issue](https://github.com/wordpressvn/poster-editor/issues) or send a [pull reguest](https://github.com/wordpressvn/poster-editor/pulls).